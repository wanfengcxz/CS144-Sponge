...
ByteStream::ByteStream(std::vector<uint8_t> vec, const size_t capacity) : _vec(std::move(vec)), _capacity(capacity) {}
...
size_t ByteStream::remaining_capacity() const { return _capacity - _used_cap; }
